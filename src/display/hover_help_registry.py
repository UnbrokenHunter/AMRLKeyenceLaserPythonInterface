...
HELP_ITEMS = {
    ...
    "#misc-state-panel": "Bridge runtime summary: stream state, serial counts, and current configuration.",
    "#misc-state": "Live bridge counters and settings.",
    "#misc-log_keep_count-label": "Number of session log files to keep. 0=unlimited.",
    "#misc-log_keep_count": "Maximum number of bridge session log files to keep in the logs folder. Use 0 for unlimited. Press Enter to apply.",
    "#misc-export_keep_count-label": "Number of exported CSV files to keep. 0=unlimited.",
    "#misc-export_keep_count": "Maximum number of CSV export files to keep in the exports folder. Use 0 for unlimited. Press Enter to apply.",
    "#misc-error": "Most recent bridge error. This turns red when an error is present.",
    "#controls": "Main controls for connection, reads, streaming, and panel visibility.",
